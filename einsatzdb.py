...
liste_einsatz = liste_einsatz = [
    
    {'id': 1, 'stichwort': 'TH0 ', 'strasse': 'Musterstr.', 'status': 'abgeschlossen',
     'liste_eintrag': [
    ...
    {'id': 2, 'stichwort': 'TH0 ', 'strasse': 'Beispiel Str.', 'status': 'in Arbeit',
     'liste_eintrag': [
    ...
    {'id': 3, 'stichwort': 'TH1 ', 'strasse': 'Hauptstr.', 'status': 'in Arbeit',
     'liste_eintrag': [
    ...
    {'id': 4, 'stichwort': 'TH0 ', 'strasse': 'Nebenstr.', 'status': 'offen', 'liste_eintrag': [
