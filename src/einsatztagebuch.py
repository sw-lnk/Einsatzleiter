...
class Eintragliste(ttk.Frame):
    def __init__(self, parent, user, db):
        ...
        self.tabel = ttk.Treeview(master=self, columns=self.headings, displaycolumns=['datum', 'eintrag', 'funker'], show='headings', height=20)        
        self.tabel.heading('datum', text='Zeitstempel', anchor='w')
        self.tabel.column('datum', width=100, minwidth=100, stretch=False)
